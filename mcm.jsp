...
<html>
    ...
    <section class="py-3">
        <div class="container">
          <div class="row">
            <div class="col-lg-9">
              <h1 class="font-weight-bold mb-0"> Ejercicio 04</h1>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-lg-6 d-flex stat my-3">
                        <div class="mx-auto">
                         <form action = "calculo4.jsp" method="post">
                            <div class="form-group">
                                <br>
                                <label>Ingrese su primer número</label>

                                <input type="number" class="form-control" name="numero1" required="" placeholder="Numero 1">
                                <br>
                                <label>Ingrese su segundo número</label>
                                <input type="number" class="form-control" name="numero2" required="" placeholder="Numero 2">
                                <br>
                            </div>
                     ...
                     <div class="col-lg-6 d-flex stat my-3">
                        <div class="mx-auto align-self-center">
                          <h6 class="tex-muted">Operaciones de</h6>
                          <h1 class="font-weight-bold">MCM Y MCD</h1>
